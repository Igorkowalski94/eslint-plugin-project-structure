...
import {
  ...
  isExportedName,
} from "rules/namingRules/helpers/validateName/helpers/isExportedName/isExportedName";
...
jest.mock(
  "rules/namingRules/helpers/validateName/helpers/isExportedName/helpers/isExportDefault",
  () => ({
...
jest.mock(
  "rules/namingRules/helpers/validateName/helpers/isExportedName/helpers/isNamedExport",
  () => ({
